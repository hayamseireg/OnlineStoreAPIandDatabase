...
import { isAuthorized, getTokenByUser } from '../middleware/authorization';
...
export default function userRoutes(app: Application) {
  ...
  app.get('/users/:id', isAuthorized, read);
  app.put('/users/:id', isAuthorized, update);
  app.delete('/users/:id', isAuthorized, deleteUser);
